...
/**
 * Internal function used by `fromObject`. Responsible for creating Error
 * instances for objects in a structure, minus the `data.cause` and
 * `data.errors` properties.
 * @private
 * @param {Object} obj - A JSON-RPC Error object.
